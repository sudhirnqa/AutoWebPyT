...
class SignupPage(BasePage):
    ...
    def fill_signup_form_and_click_continue_btn(self, test_data):
        ...
        if isinstance(test_data, dict):
            ...
            self.enter_company_name(test_data['company_name'])
            ...
            self.enter_zipcode(test_data['zip_code'])
            ...
            if not self.account_created_header.is_element_displayed():
                ...
                raise Exception("Account creation failed. Please check the provided data.")
        else:
